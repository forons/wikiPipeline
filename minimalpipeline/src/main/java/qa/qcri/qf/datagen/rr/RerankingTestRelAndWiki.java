 ...
 */
public class RerankingTestRelAndWiki implements Reranking {
	...
	public RerankingTestRelAndWiki(FileManager fm, String outputDir, Analyzer ae,
			TreeSerializer ts, PairFeatureFactory pairFeatureFactory,
			TokenTreeProvider tokenTreeProvider, MarkTreesOnWikipedia markerWiki, MarkTreesOnRepresentation markerRel) throws UIMAException {
		this.fm = fm;
	...
	public void generateData(DataObject questionObject,
		...
		for (DataObject candidateObject : candidateObjects) {
			 ...
			 */
			this.markerWiki.markTrees(questionTree, candidateTree, this.parameterList);
			
			this.markerRel.markTrees(questionTree, candidateTree, this.parameterList);
	 ...
	 * @return
	 */
	public RerankingTestRelAndWiki setParameterList(String parameterList) {

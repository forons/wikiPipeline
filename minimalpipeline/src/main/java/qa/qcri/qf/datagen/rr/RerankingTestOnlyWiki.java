 ...
 */
public class RerankingTestOnlyWiki implements Reranking {
	...
	private MarkTreesOnWikipedia marker;
	...
	public RerankingTestOnlyWiki(FileManager fm, String outputDir, Analyzer ae,
			TreeSerializer ts, PairFeatureFactory pairFeatureFactory,
			TokenTreeProvider tokenTreeProvider, MarkTreesOnWikipedia marker) throws UIMAException {
		this.fm = fm;
	 ...
	 * @return
	 */
	public RerankingTestOnlyWiki setParameterList(String parameterList) {

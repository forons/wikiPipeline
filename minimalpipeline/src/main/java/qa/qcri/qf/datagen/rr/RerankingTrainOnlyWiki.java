 ...
 */
public class RerankingTrainOnlyWiki implements Reranking {
	...
	public RerankingTrainOnlyWiki(FileManager fm, String outputDir, Analyzer ae,
			TreeSerializer ts, PairFeatureFactory pairFeatureFactory, TokenTreeProvider tokenTreeProvider,
			MarkTreesOnWikipedia marker) throws UIMAException {
		this.fm = fm;
	 ...
	 * @return
	 */
	public RerankingTrainOnlyWiki setParameterList(String parameterList) {

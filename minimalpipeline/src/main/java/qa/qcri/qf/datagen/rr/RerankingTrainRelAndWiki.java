 ...
 */
public class RerankingTrainRelAndWiki implements Reranking {
	...
	private MarkTreesOnWikipedia markerWiki;
	
	private MarkTreesOnRepresentation markerRel;
	...
	public RerankingTrainRelAndWiki(FileManager fm, String outputDir, Analyzer ae,
			TreeSerializer ts, PairFeatureFactory pairFeatureFactory, TokenTreeProvider tokenTreeProvider,
			MarkTreesOnWikipedia markerWiki, MarkTreesOnRepresentation markerRel) throws UIMAException {
		this.fm = fm;
		...
		this.markerWiki = markerWiki;
		this.markerRel = markerRel;
	...
	public void generateData(DataObject questionObject,
		...
		for (Pair<DataPair, DataPair> trainingPair : trainingPairs) {
			 ...
			 */
			this.markerRel.markTrees(leftQuestionTree, leftCandidateTree, this.parameterList);
			this.markerRel.markTrees(rightQuestionTree, rightCandidateTree, this.parameterList);
			this.markerWiki.markTrees(leftQuestionTree, leftCandidateTree, this.parameterList);
			this.markerWiki.markTrees(rightQuestionTree, rightCandidateTree, this.parameterList);
	 ...
	 * @return
	 */
	public RerankingTrainRelAndWiki setParameterList(String parameterList) {

...
public class TreeSerializer {
	...
	private boolean enableWikipediaTags = false;
	 ...
	 * @return the current TreeSerialized instance (for chaining)
	 */
	public TreeSerializer enableWikipediaTags() {
		this.enableWikipediaTags = true;
		return this;
	}
	 ...
	 * @return the current TreeSerialized instance (for chaining)
	 */
	public TreeSerializer disableWikipediaTags() {
		this.enableWikipediaTags = false;
		return this;
	}
	...
	/**
	 * Serializes a tree starting from the specified node using an empty
	 * parameter list
	 * 
	 * @param node
	 *            the root node of the tree
